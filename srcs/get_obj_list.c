...
// 	ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_SPHERE, get_t_refrect(b_color_get(0, 0.1, 0.1, 0.1), b_color_get(0.0, 0.0, 0.69, 0.69), b_color_get(0, 0.30, 0.30, 0.30), 5, false, (t_bright_color){0.5, 0.5, 0.5, 0.5}),
// 		make_sphere_instance(get_vec(-4, 6, 10), 3, gb_list), gb_list)));
// 	ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_SPHERE, get_t_refrect(b_color_get(0, 0.1, 0.1, 0.1), b_color_get(0.0, 0.69, 0, 0.69), b_color_get(0, 0.30, 0.30, 0.30), 5, false, (t_bright_color){0.5, 0.5, 0.5, 0.5}),
// 		make_sphere_instance(get_vec(4, 6, 10), 3, gb_list), gb_list)));
// 	ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_SPHERE, get_t_refrect(b_color_get(0, 0.1, 0.1, 0.1), b_color_get(0.0, 0.0, 0.69, 0.0), b_color_get(0, 0.30, 0.30, 0.30), 5, false, (t_bright_color){0.5, 0.5, 0.5, 0.5}),
// 		make_sphere_instance(get_vec(-4, -2, 10), 3, gb_list), gb_list)));
// 	ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_SPHERE, get_t_refrect(b_color_get(0, 0.1, 0.1, 0.1), b_color_get(0.0, 0.69, 0.69, 0.0), b_color_get(0, 0.30, 0.30, 0.30), 5, false, (t_bright_color){0.5, 0.5, 0.5, 0.5}),
// 		make_sphere_instance(get_vec(4, -2, 10), 3, gb_list), gb_list)));
...
// 	// ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_SPHERE, get_t_refrect(b_color_get(0, 0.1, 0.1, 0.1), b_color_get(0.0, 0.0, 0.69, 0.0), b_color_get(0, 0.30, 0.30, 0.30), 0, false, (t_bright_color){0, 0, 0, 0}),
// 	// 	make_sphere_instance(get_vec(0, 1, 10), 1, gb_list), gb_list)));

// 	ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_SPHERE, get_t_refrect(b_color_get(0, 0.1, 0.1, 0.1), b_color_get(0.0, 0.0, 0.69, 0.0), b_color_get(0, 0.30, 0.30, 0.30), 5, true, (t_bright_color){0.5, 0.5, 0.5, 0.5}),
// 		make_sphere_instance(get_vec(0, 1, 10), 1, gb_list), gb_list)));

// 	ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_SPHERE, get_t_refrect(b_color_get(0, 0.1, 0.1, 0.1), b_color_get(0.0, 0.0, 0.0, 0.69), b_color_get(0, 0.30, 0.30, 0.30), 0, false, (t_bright_color){0, 0, 0, 0}),
// 		make_sphere_instance(get_vec(1, 1, 15), 1, gb_list), gb_list)));

// 	ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_SPHERE, get_t_refrect(b_color_get(0, 0.1, 0.1, 0.1), b_color_get(0.0, 0.0, 0.69, 0.69), b_color_get(0, 0.30, 0.30, 0.30), 1, false, (t_bright_color){0, 0, 0, 0}),
// 		make_sphere_instance(get_vec(2, 1, 20), 1, gb_list), gb_list)));

// 	ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_SPHERE, get_t_refrect(b_color_get(0, 0.1, 0.1, 0.1), b_color_get(0.0, 0.69, 0.0, 0.69), b_color_get(0, 0.30, 0.30, 0.30), 1, false, (t_bright_color){0, 0, 0, 0}),
// 		make_sphere_instance(get_vec(3, 1, 25), 1, gb_list), gb_list)));

// 	ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_SPHERE, get_t_refrect(b_color_get(0, 0.1, 0.1, 0.1), b_color_get(0.0, 0.69, 0.0, 0.0), b_color_get(0, 0.30, 0.30, 0.30), 0, false, (t_bright_color){0, 0, 0, 0}),
...
// 	// 	make_plane_instance(vec_normalize(get_vec(0, 1, 0)), get_vec(0, 0, 0),  gb_list), gb_list)));

// 	// ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_PLANE, get_t_refrect(b_color_get(0, 0.0, 0.8, 0.0), b_color_get(0, 0.0, 0.8, 0.0), b_color_get(0, 0.0, 0.8, 0.0), 1, false, (t_bright_color){0, 0, 0, 0}),
// 	// 	make_plane_instance(vec_normalize(get_vec(0, 1, 0)), get_vec(0, 10, 0),  gb_list), gb_list)));
...
// 	// 	make_plane_instance(vec_normalize(get_vec(1, 0, 0)), get_vec(-6, 0, 0),  gb_list), gb_list)));
...
// 	// 	make_plane_instance(vec_normalize(get_vec(0, 0, 1)), get_vec(0, 0, 40),  gb_list), gb_list)));
...
// 	// ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_SPHERE, get_t_refrect(b_color_get(0, 0, 0, 0), b_color_get(0, 0, 0, 0.0), b_color_get(0, 0, 0, 0), 5, true, (t_bright_color){1.0, 1.0, 1.0, 1.0}),
// 	// 	make_sphere_instance(get_vec(-0.25, -0.5, 1), 0.5, gb_list), gb_list)));
...
// 	// ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_SPHERE, get_t_refrect(b_color_get(0, 0, 0, 0), b_color_get(0, 0, 0, 0.0), b_color_get(0, 0, 0, 0), 5, true, (t_bright_color){1.0, 1.0, 1.0, 1.0}),
// 	// 	make_sphere_instance(get_vec(0.5, 0.5, 1), 0.5, gb_list), gb_list)));

// 	// ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_SPHERE, get_t_refrect(b_color_get(0, 0, 0, 0), b_color_get(0, 0, 0, 0.0), b_color_get(0, 0, 0, 0), 5, true, (t_bright_color){1.0, 1.0, 1.0, 1.0}),
// 	// 	make_sphere_instance(get_vec(0.5, -0.5, -1), 0.5, gb_list), gb_list)));

// 	// ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_SPHERE, get_t_refrect(b_color_get(0,0.2,0.4,0.6), b_color_get(0,0.2,0.4,0.6), b_color_get(0,0.2,0.4,0.6), 5, false, (t_bright_color){0,0,0,0}),
// 	// 	make_sphere_instance(get_vec(-0.25, -0.5, 3), 0.5, gb_list), gb_list)));
...
// 		make_plane_instance(vec_normalize(get_vec(0, 1, 0)), get_vec(0, -1, 0),  gb_list), gb_list)));
...
// 	// 	make_plane_instance(vec_normalize(get_vec(-1, 0, 0)), get_vec(1, 0, 0),  gb_list), gb_list)));
...
// 		make_plane_instance(vec_normalize(get_vec(0, 0, -1)), get_vec(0, 0, 5),  gb_list), gb_list)));
...
// 	// 	make_plane_instance(vec_normalize(get_vec(0, 0, 1)), get_vec(0, 0, -10),  gb_list), gb_list)));
// 	return (obj_list);
// }
...
t_dlist	*get_obj_list(void)
{
	...
	ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_SPHERE, get_t_refrect(b_color_get(0, 0, 0, 0), b_color_get(0, 0, 0, 0.0), b_color_get(0, 0, 0, 0), 5, true, (t_bright_color){1.0, 1.0, 1.0, 1.0}),
		make_sphere_instance(get_vec(-0.25, -0.5, 1), 0.5))));
	...
	ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_PLANE, get_t_refrect(b_color_get(0, 0.0, 0.0, 0.0), b_color_get(0.0,0,0,0), b_color_get(0, 0.0, 0.0, 0.0), 1, true, (t_bright_color){0,1,1,1}),
		make_plane_instance(vec_normalize(get_vec(0, 1, 0)), get_vec(0, -1, 0)))));
	...
	ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_PLANE, get_t_refrect(b_color_get(0, 0.0, 0.0, 0.0), b_color_get(0.0, 0, 1, 0), b_color_get(0, 0.0, 0.0, 0.0), 1, true, (t_bright_color){0,1,1,1}),
		make_plane_instance(vec_normalize(get_vec(-1, 0, 0)), get_vec(1, 0, 0)))));
	...
	ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_PLANE, get_t_refrect(b_color_get(0,0,0,0.1), b_color_get(0,0,0,0), b_color_get(0, 0.0, 0.0, 0.0), 1, true, (t_bright_color){0,1,1,1}),
		make_plane_instance(vec_normalize(get_vec(0, 0, -1)), get_vec(0, 0, 5)))));

	ft_dlstadd_back(&obj_list, ft_dlstnew(new_obj(O_PLANE, get_t_refrect(b_color_get(0,0,0,0.1), b_color_get(0,0,0,0), b_color_get(0, 0.0, 0.0, 0.0), 1, true, (t_bright_color){0,1,1,1}),
		make_plane_instance(vec_normalize(get_vec(0, 0, 1)), get_vec(0, 0, -10)))));
